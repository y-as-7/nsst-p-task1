  ...
  return (
    <div className="mt-28 w-[90%] mx-auto">
      <div className="text-center">
        ...
        deriving acceleration from distance
      ...
      <div className='w-full flex justify-center'>
        ...
        <Link className="mx-1 my-1  " href="/laws/12">
                ...
                x5|| x4||x3|| x2 ||x1 || numb ?(
                    <div className='flex justify-center items-center text-center mx-auto flex-wrap'>
                            <span className='text-red-700 text-2xl  mr-2'>a= </span> 
                            {
                                Number(x5)?(
                                    <div className='flex items-center'>
                                        <span className=' flex items-center justify-center text-2xl'> {5*4*x5} x <sup>3</sup></span>
                                        {Number(x4) ?(
                            ...
                            }
                            {
                               Number(x4)?(
                                    <div className='flex items-center'>
                                        <span className=' flex items-center justify-center text-2xl'> {4*3*x4} x <sup>2</sup></span>
                                        {Number(x3) ?(
                                        <span className='mx-2'> + </span>
                                       ):(
                                        <span></span>
                            ...
                            }
                            {
                               Number(x3)?(
                                    <div className='flex items-center'>
                                        <span className=' flex items-center justify-center text-2xl'> {3*2*x3} x <sup>2</sup></span>
                                        {Number(x2) ?(
                                        <span className='mx-2'> + </span>
                                       ):(
                                        <span></span>
                            ...
                            }
                            {
                               Number(x2)?(
                                    <div className='flex items-center'>
                                        <span className=' flex items-center justify-center text-2xl'> {2*x2} x </span>
                                       {Number(x1) ?(
                                        <span className='mx-2'> + </span>
                                       ):(
                                        <span></span>
